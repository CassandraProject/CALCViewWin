...
CBD clears the Bad status bit of the specified output parameter to False. Its effect is identical
...
struct Instruction_CBD: public Instruction_Interface
{
    Instruction_CBD() {
    ...
    void Run (Steps_Table_Model &steps, Stack_Table_Model &stack, Machine &reg) {
        ...
        reg.Index_To_Memory(s->Get_Register1())->Set_Status(Mem_Status::BAD, false);
