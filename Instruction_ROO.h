...
ROO reads the Out-of-Service status bit of the specified parameter and writes its value to the 
accumulator. (1 = True = OOS bit set, 0 = False = OOS bit not set.)

The result of the ROO instruction is always the inverse of the result of the RON instruction. 
...
struct Instruction_ROO: public Instruction_Interface
{
    Instruction_ROO() {
    ...
    bool Check (Mem_Step &s, Machine &mem) {
        return 	(s.RIxx_1() || s.IIxx_1() || s.BIxx_1() || s.ROxx_1() || 
                s.IOxx_1() || s.LOxx_1() || s.BOxx_1()) && s.Empty_2();
    }
