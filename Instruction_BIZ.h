...
BIZ s branches to the step number designated by s if the value in the accumulator (the current top of
...
the step number containing the END statement (50 if there is no END step), writes a "-4" (invalid goto
syntax error) to the PERROR parameter. 

CHECKED: March 14, 2003
*/
#include    "Instruction_Interface.h"

struct Instruction_BIZ: public Instruction_Interface
{
    Instruction_BIZ() {
