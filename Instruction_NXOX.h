...
NXOX reads all the values or a specified number (c) of values from the stack, performs a 16-bit 
bitwise logical "nxor" function on them, and stores the result into the new accumulator location 
(the new top of stack). This overwrites the first operand and isolates the other operands from 
any further access-> Not Exclusive Or is defined as producing a True output for an even number 
of True inputs, a False output for an odd number of True inputs, and a True output if all inputs 
are False.
...
The final result is stored on the stack as a real value.

CHECKED: March 28, 2003
*/
#include    "Instruction_Interface.h"

struct Instruction_NXOX: public Instruction_Interface
{
    Instruction_NXOX() {
