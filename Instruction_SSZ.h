...
SSZ sets the specified operand to 1.0 (if ROxx or Mxx) or 1 (if IOxx or LOxx) or True (if BOxx) 
and skips the next program step when the accumulator value is 0.0. Otherwise the instruction is 
...
struct Instruction_SSZ: public Instruction_Interface
{
    Instruction_SSZ() {
