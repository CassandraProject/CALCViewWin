...
INH reads the high order 16 bits of parameter LIxx or LOxx as an integer and pushes it onto
the stack. sptr(after) = sptr(before) + 1.

CHECKED: March 28, 2003
*/
#include    "Instruction_Interface.h"

struct Instruction_INH: public Instruction_Interface
{
    Instruction_INH() {
    ...
    void Run (Steps_Table_Model &steps, Stack_Table_Model &stack, Machine &reg) {
        ...
        try {
            ...
            stack.Push((float) ((r >> 16) & 0x0000FFFF));
        }
