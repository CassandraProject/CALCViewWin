...
ORX reads all the values or a specified number (c) of values from the stack, performs a 16-bit 
bitwise logical "or" function on them, and stores the result into the new accumulator location 
...
struct Instruction_ORX: public Instruction_Interface
{
    Instruction_ORX() {
