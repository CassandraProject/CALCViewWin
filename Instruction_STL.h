...
STL stores the last stack value into the low order integer of the specified long integer 
...
struct Instruction_STL: public Instruction_Interface
{
    Instruction_STL() {
    ...
    void Run (Steps_Table_Model &steps, Stack_Table_Model &stack, Machine &reg) {
        ...
        reg.Index_To_Memory(s->Get_Register1())->Set_Value((float) ((acc & 0x0000FFFF) | (0xFFFF0000 & old)));
