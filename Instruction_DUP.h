...
DUP copies the last stack operand back onto the stack. The stack pointer is advanced one position. 
...
struct Instruction_DUP: public Instruction_Interface
{
    Instruction_DUP() {
