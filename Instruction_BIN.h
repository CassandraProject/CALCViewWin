...
BIN s branches to the step number designated by s if the value in the accumulator (the current top of 
...
struct Instruction_BIN: public Instruction_Interface
{
    Instruction_BIN() {
